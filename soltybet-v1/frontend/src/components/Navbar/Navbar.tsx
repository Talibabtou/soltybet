...
const Navbar = () => {
    ...
    if (connected && publicKey) {
      ...
      return () => {
        if (subscriptionId.current !== null && connection.current) {
          connection.current
            .removeAccountChangeListener(subscriptionId.current)
  ...
  useEffect(() => {
    ...
    return () => {
      if (tickerElement) {
        tickerElement.removeEventListener(
          "animationiteration",
          handleAnimationEnd
        );
      }
        ...
        <div className="hamburger-menu" ref={menuRef}>
          ...
          {isMenuOpen && (
            <div className="menu-items">
              <a
                href="https://discord.com/invite/Uf8Uf2hcQT"
                target="_blank"
      ...
      <div className="navbar-center">
        ...
        <div className="match-history">
          ...
          {matchHistory.map((winner, index) => (
            <div
              key={index}
              className={`history-dot ${winner.toLowerCase()}`}
            ></div>
          ))}
        </div>
      </div>
        ...
        <div className="help-icon">
          ...
          <div className="tooltip">
            ...
            <div className="tooltip-content">
              <p className="intro">
                Just bet on which fighter you think will win the match, Red or
                Blue.
              </p>
              ...
              <div className="match-type">
                ...
                <p>
                  The most fair format: two fighters from the same tier compete
                  in a Best of 3.
                </p>
              </div>
